...
<?php 
require "Connect.php";
$query="select promovidos.id,promovidos.municipio,count(promovidos.municipio) as cuenta from promovidos GROUP BY promovidos.municipio ORDER by count(promovidos.municipio) DESC limit 10";
