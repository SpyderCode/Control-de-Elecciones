...
<?php 
require "Connect.php";
$query="select colonia,colonia,count(colonia) from promovidos GROUP BY colonia ORDER by count(*) DESC limit 10";
...
<head>
<meta charset="utf-8">
<title>GráficaColoniaComunidad</title>
...
<body onload="checksession()">
	...
	<div class="primary_header">
	    <h1 class="title">GRÁFICA POR COLONIA O COMUNIDAD</h1>
		</div>
 ...
 <div class="navbar">
   <div class ="dropdown">
	...
	<div class="contenido">
     ...
     <tr>
        <th>Nombre De Colonia/Comunidad</th>
		<th>No. De Promovidos</th>
    </tr>
         <?php 
        while ($row=mysqli_fetch_array($result)){
            echo "<tr>";
            echo "<td>" . $row["colonia"] . "</td>";
            echo "<td>" . $row["count(colonia)"] . "</td>";
            echo "</tr>"; 
}?>
	   </table>
	  </div>	
...
<script>
 ...
 var options = {
          chart: {
            title: 'Top De Colonias/Comunidades',
            subtitle: 'Las Colonias/Comunidades con mayor número de promovidos',
          },
...
function download(){
    ...
    saveimage(image64,"GraficaComunidad");    
    });
