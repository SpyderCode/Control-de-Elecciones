...
$sql="UPDATE promotores SET Nombre='$name',paterno='$paterno',materno='$materno',domicilio='$domicilio',colonia='$colonia',municipio='$municipio', seccion='$seccion', ocr='$ocr',telefono='$telefono' WHERE id='$id'";
