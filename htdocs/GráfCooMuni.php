...
<?php 
require "Connect.php";
$query="select promovidos.id,promovidos.municipio,count(promovidos.municipio) as Municipio from promovidos GROUP BY promovidos.municipio ORDER by count(promovidos.municipio) DESC limit 10";
...
<div class="conteiner">
	<div class="primary_header">
	    <h1 class="title">GRÁFICA POR MUNICIPIO</h1>
		</div>
	<div class="navbar">
		<div class ="dropdown">
...
<script>
 ...
 var options = {
          chart: {
            title: 'Top De Municipios',
            subtitle: 'Los municipios con mayor número de promovidos',
          },
...
function download(){
    ...
    saveimage(image64,"GraficaMunicipio");    
    });
